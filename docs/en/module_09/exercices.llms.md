...
Before starting, review the module resources if needed: the ModernDive chapters on simple and multiple regression, the `lm()` documentation, the `predict.lm()` documentation and the module formative mini-test.
