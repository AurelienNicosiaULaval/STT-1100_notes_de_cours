...
- [Introduction to Modern Statistics - Explore categorical data](https://openintro-ims.netlify.app/explore-categorical) To review frequencies, proportions, cross-tabulations and charts for categorical variables.
