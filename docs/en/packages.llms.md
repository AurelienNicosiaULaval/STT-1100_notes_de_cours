...
Data and examples package used in the first course modules. Course package, GitHub installation
...
Color palettes adapted to statistical graphics. External documentation [WEA ](https://CRAN.R-project.org/package=weathercan)

## weathercan

Former Canadian weather data package; check its status before using it in new work. Archived CRAN page [WOR ](https://CRAN.R-project.org/package=wordcloud)
