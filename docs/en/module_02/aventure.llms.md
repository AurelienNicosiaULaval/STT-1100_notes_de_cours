...
> **NOTE:**
>
> You must have received and accepted the invitation to your private `aventure-2-YOUR-USERNAME` repository. If GitHub and RStudio are not connected yet, follow [Connecting GitHub to RStudio with SSH](../autre_materiel/connexion-ssh-github-rstudio.llms.md). The procedure mainly uses menus and buttons.
...
> **IMPORTANT:**
>
> Stop here. Before closing RStudio:
>
> 1.  check that your name and answers are in `journal de bord.qmd`;
> 2.  render the logbook to create `journal de bord.html`;
> 3.  open the HTML file and check the result;
> 4.  make a clear commit, then push it to GitHub.
>
> You do not need to create `rapport_analyse.qmd` yet. Part 2 begins below.
