...
1.  Evening workshops cause higher participation.
2.  In this file, evening workshops have higher mean participation.
3.  Morning workshops are useless.
4.  The data prove that temperature has no effect.
...
1.  To practise the same skills without directly giving away the challenge solution
2.  To avoid the readings
3.  To replace the adventure
4.  To remove visualizations
