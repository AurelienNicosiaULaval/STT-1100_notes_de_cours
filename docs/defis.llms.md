...
1.  Lire la consigne complète et identifier le produit attendu.
2.  Revenir à l'aventure du module pour retrouver le contexte, les données et les gestes utiles.
3.  Construire une première version simple qui fonctionne.
4.  Rendre le fichier, tester les liens ou fichiers de sortie, puis relire comme une personne externe.
5.  Soumettre le bon fichier ou le bon dépôt selon les consignes confirmées sur Brio.
