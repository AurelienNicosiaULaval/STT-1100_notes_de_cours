...
Package de données et exemples utilisé dans les premiers modules du cours. Package du cours, installation GitHub
...
Palettes de couleurs adaptées aux graphiques statistiques. Documentation externe [WEA ](https://CRAN.R-project.org/package=weathercan)

## weathercan

Ancien package de données météorologiques canadiennes; à vérifier avant de l’utiliser dans un nouveau travail. Page CRAN archivée [WOR ](https://CRAN.R-project.org/package=wordcloud)
