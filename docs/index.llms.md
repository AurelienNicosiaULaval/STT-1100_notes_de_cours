...
Un portail de cours pour suivre le parcours, trouver les ressources et transformer les notes en actions concrètes.

## Cette semaine

Commence par le module actif annoncé en classe ou sur MonPortail, puis utilise cette page pour retrouver rapidement les notes, les activités et les livrables.

[Démarrer le cours](demarrage.llms.md) [Voir les modules](modules.llms.md) [Projet de session](projet_session/index.llms.md)

## Accès rapides

### Démarrage

Installer les outils et comprendre le flux de travail minimal.

[Ouvrir](demarrage.llms.md)

### Évaluations

Retrouver les livrables, les traces attendues et les repères d’évaluation.

[Ouvrir](evaluations.llms.md)

### Boîte à outils

Fonctions R, Quarto, GitHub et routines de dépannage.

[Ouvrir](boite_outils.llms.md)
