...
Chaque module ajoute une compétence visible. Le chemin va d'un premier rapport reproductible vers des productions plus autonomes: collaboration, éthique, automatisation, prédiction et tableau de bord. Le module 2 est volontairement plus long et se travaille en deux temps.
...
[R ProjectTéléchargement officiel.](https://www.r-project.org/)

### RStudio

L'environnement de travail utilisé pour écrire le code, gérer les projets et produire les rapports.

[RStudio DesktopTéléchargement depuis Posit.](https://posit.co/download/rstudio-desktop/)
...
[GitInstallation locale.](https://git-scm.com/)[GitHub DocsDocumentation officielle.](https://docs.github.com/)
