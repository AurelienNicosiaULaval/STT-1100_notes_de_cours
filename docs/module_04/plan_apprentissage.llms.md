...
- [R for Data Science - Data import](https://r4ds.hadley.nz/data-import.html) Pour importer des fichiers rectangulaires, contrôler les types et repérer les problèmes d’importation.

- [Documentation `readr::read_delim()`](https://readr.tidyverse.org/reference/read_delim.html) Pour comprendre le rôle du séparateur, très important lorsque le fichier n’est pas séparé par des virgules.

- [R for Data Science - Data tidying](https://r4ds.hadley.nz/data-tidy.html) Pour revoir la logique des données tidy et les transformations long-large.

- [R for Data Science - Missing values](https://r4ds.hadley.nz/missing-values.html) Pour distinguer les valeurs manquantes explicites, les valeurs codées comme manquantes et les valeurs implicites.

- [R for Data Science - Factors](https://r4ds.hadley.nz/factors.html) Pour recoder, regrouper et ordonner des variables catégoriques.

- [R for Data Science - Spreadsheets](https://r4ds.hadley.nz/spreadsheets.html) Pour importer des fichiers Excel et sélectionner une feuille précise.
