---
title: ""
pagetitle: "Connexion SSH entre GitHub et RStudio - STT-1100"
...
<div class="resource-page installation-page">
  <section class="resource-hero" aria-labelledby="ssh-title">
    <div>
      <p class="eyebrow">Configuration à faire une seule fois</p>
      <h1 id="ssh-title">Connecter GitHub à RStudio avec SSH</h1>
      <p>Cette procédure utilise surtout les menus et les boutons de RStudio et de GitHub. À la fin, votre ordinateur pourra ouvrir et synchroniser les dépôts GitHub du cours.</p>
      <div class="resource-actions" aria-label="Accès rapides">
        <a class="home-action home-action--primary" href="#verifier-git">Commencer</a>
        <a class="home-action" href="#tester-connexion">Tester la connexion</a>
        <a class="home-action" href="#cloner-projet">Cloner un projet</a>
        <a class="home-action" href="#depannage-ssh">Dépanner</a>
      </div>
    </div>
    <div class="resource-panel" aria-label="Parcours de connexion">
      <div><span>01</span><p>Vérifier Git dans RStudio</p></div>
      <div><span>02</span><p>Créer une clé SSH</p></div>
      <div><span>03</span><p>Ajouter la clé à GitHub</p></div>
      <div><span>04</span><p>Tester puis cloner</p></div>
    </div>
  </section>
</div>
```
...
## 1. Vérifier que RStudio trouve Git {#verifier-git}
...
## 4. Tester la connexion {#tester-connexion}
...
## 5. Cloner le dépôt du cours {#cloner-projet}
...
## Dépannage très court {#depannage-ssh}
