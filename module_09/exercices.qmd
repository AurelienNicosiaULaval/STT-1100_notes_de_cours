...
<a class="btn btn-primary" href="../downloads/donnees/stt1100-module-09-fr.zip" download>Télécharger le dossier prêt à ouvrir (.zip)</a>
...
```{r}
#| fig-alt: "Nuage de points de l'eau distribuée selon la consommation résidentielle, accompagné d'une droite de régression linéaire."
ggplot(
  eau,
  aes(
...
```{r}
#| fig-alt: "Nuage de points des erreurs du modèle selon les valeurs prédites, avec une ligne horizontale à zéro."
ggplot(
  diagnostic_modele,
...
```{r}
#| fig-alt: "Diagramme à bandes horizontal de la proportion de municipalités ayant un indice de validité disponible, par région."
