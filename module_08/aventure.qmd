...
Aujourd'hui, vous êtes engagé·e par **Marie-Pier**, directrice de recherche à l'Institut québécois pour les données durables. Elle souhaite explorer le portail [donnéesquebec.ça](https://www.donneesquebec.ca) pour identifier les jeux de données les plus récents et pertinents pour ses projets. Votre mission : **concevoir un outil de scraping fiable** pour extraire les titres, producteurs et catégories de jeux de données, tout en respectant les bonnes pratiques éthiques.
