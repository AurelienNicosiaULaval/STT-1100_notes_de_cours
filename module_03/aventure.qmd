...
<span class="adventure-brief-value">Média local fictif et Ville de Montréal</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Mission</span>
<span class="adventure-brief-value">Produire un article clair sur les infractions alimentaires montréalaises</span>
</div>
<div class="adventure-brief-item">
...
```{r}
#| fig-alt: "Diagramme à barres montrant le nombre d'infractions à Montréal par type d'établissement."
library(ggplot2)
