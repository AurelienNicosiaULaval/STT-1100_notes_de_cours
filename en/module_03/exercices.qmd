...
<a class="btn btn-primary" href="../../downloads/donnees/stt1100-module-03-en.zip" download>Download the ready-to-open workspace (.zip)</a>
...
```{r}
#| fig-alt: "Horizontal bar chart of request counts, ordered from the most frequent service to the least frequent."
campus_services |>
...
```{r}
#| fig-alt: "One-hundred-percent stacked bar chart comparing status composition across campuses."
campus_services |>
  count(campus, status) |>
  group_by(campus) |>
...
```{r}
#| fig-alt: "Horizontal boxplots comparing the distribution of reported costs across services."
campus_services |>
...
```{r}
#| fig-alt: "Horizontal bar chart showing the share of requests assigned to each service."
...
```{r}
#| fig-alt: "Horizontal bar chart of the twelve most frequent categories in the Montréal 311 request extract."
...
```{r}
#| fig-alt: "One-hundred-percent stacked bar chart comparing consumer complaint categories by head-office city."
