...
::: {.callout-important title="Check the appearance before submitting"}
The final HTML should look like an article: prose, readable charts and interpreted findings. Code, raw console output and package messages should be hidden or removed. Consult the [Quarto model for article presentation](modele_article_quarto.qmd) before your final review.
:::
