---
title: ""
pagetitle: "SSH connection between GitHub and RStudio - STT-1100"
...
<div class="resource-page installation-page">
  <section class="resource-hero" aria-labelledby="ssh-title">
    <div>
      ...
      <h1 id="ssh-title">Connect GitHub to RStudio with SSH</h1>
      <p>This procedure mainly uses RStudio and GitHub menus and buttons. At the end, your computer will be able to open and synchronize the course GitHub repositories.</p>
      <div class="resource-actions" aria-label="Quick links">
        <a class="home-action home-action--primary" href="#check-git">Start</a>
        <a class="home-action" href="#test-connection">Test the connection</a>
        <a class="home-action" href="#clone-project">Clone a project</a>
        <a class="home-action" href="#ssh-troubleshooting">Troubleshoot</a>
      </div>
    </div>
    <div class="resource-panel" aria-label="Connection path">
      <div><span>01</span><p>Check Git in RStudio</p></div>
      <div><span>02</span><p>Create an SSH key</p></div>
      <div><span>03</span><p>Add the key to GitHub</p></div>
      <div><span>04</span><p>Test and clone</p></div>
    </div>
  </section>
</div>
```
...
## 1. Check that RStudio finds Git {#check-git}
...
## 5. Clone the course repository {#clone-project}
...
## Short troubleshooting guide {#ssh-troubleshooting}
