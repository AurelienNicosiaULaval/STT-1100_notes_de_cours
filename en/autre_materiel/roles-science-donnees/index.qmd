...
![Complete cycle of a data science project, from import to communication](whole-game.png){fig-align="center" width="800"}
...
| **Understand** (Tidy -> Transform -> Visualize <-> Model) | *Statistician, Data Scientist, Data Analyst* | Extract knowledge through analyses and models. |
...
**At work:**\
- Prepares reports, performance indicators and dashboards.\
- Queries databases, aggregates information and creates clear visualizations.\
