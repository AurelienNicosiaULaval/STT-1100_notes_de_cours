...
\subsection{Core packages}\label{core-packages}
...
\section{\texorpdfstring{ DATA WRANGLING -
\texttt{dplyr}}{ DATA WRANGLING - dplyr}}\label{data-wrangling-dplyr}

\subsection{Core verbs}\label{core-verbs}
