...
You will complete a full analysis using a real or realistic dataset selected by your team and validated when needed.

Your task is to formulate a relevant question, explore the data reproducibly, produce useful visualizations, and communicate interpretable results for a non-specialist audience.
...
## 1. Proposal — date to be confirmed in MonPortail
...
| Data | 4 |
| Proposal content | 4 |
| Code quality and repository structure | 2 |

## 2. Presentation — date to be confirmed in MonPortail

Make a **presentation of 15 minutes maximum**, where each member speaks. Use `xaringan` to create your slides. The presentation date will be confirmed in MonPortail.
...
## 3. Final report (`README`) — date to be confirmed in MonPortail
...
project/
  ...
  presentation/      # xaringan slides and rendered HTML
  README.Rmd         # Reproducible final summary
  README.md          # Final summary rendered on GitHub
```

The repository must be clean, well structured, and reflect a reproducible approach.
...
| Peer review | 10 |
| Peer evaluation by classmates | 5 |
| **Total** | **100** |
...
- Keep code visible in analysis documents, except in final slides when hiding code improves readability.
