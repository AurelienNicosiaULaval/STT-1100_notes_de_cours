...
<div class="resource-page readings-page">
  <section class="resource-hero" aria-labelledby="books-title">
    <div>
      ...
      <div class="resource-actions" aria-label="Quick access">
        ...
        <a class="home-action" href="#targeted-complements">Targeted complements</a>
  ...
  <section class="resource-section" id="targeted-complements" aria-labelledby="complements-title">
    <div class="resource-section__header">
      <h2 id="complements-title">Targeted Complements</h2>
      <p>These resources are not meant to be read all at once. They support specific moves required by a module, challenge or project.</p>
    </div>
    <div class="reading-grid">
  ...
  <section class="resource-section" id="module-readings" aria-labelledby="readings-title">
    ...
    <div class="reading-map">
      ...
      <article><h3>Module 05</h3><p><a href="#r4ds">R for Data Science</a> for EDA, dates, visualization and missing values; <a href="#openintro">OpenIntro Statistics</a> for numerical exploration; <a href="#r-graphics-cookbook">R Graphics Cookbook</a> for refining a graph.</p></article>
      ...
      <article><h3>Module 07</h3><p><a href="#r4ds">R for Data Science</a> for communication, <a href="#wilke-dataviz">Wilke</a>, the <a href="#rss-dataviz">RSS guide</a> and <a href="#r-graphics-cookbook">R Graphics Cookbook</a> for responsible visualization, then <a href="#quebec-anonymisation">Québec</a>, <a href="#cnil-anonymisation">CNIL</a> and <a href="#fair-principles">FAIR</a> for anonymization and data reuse.</p></article>
      ...
      <article><h3>Module 09</h3><p><a href="#moderndive">ModernDive</a> for simple and multiple regression, <a href="#r-lm-docs">lm()</a> and <a href="#r-predict-lm-docs">predict.lm()</a> for the R implementation, then the <a href="#canada-adm-guide">Government of Canada guide</a> and <a href="#nist-bias-ai">NIST SP 1270</a> for discussing bias and automated decisions.</p></article>
