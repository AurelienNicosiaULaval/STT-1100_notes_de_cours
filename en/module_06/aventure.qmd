...
|-----------------|-----------------|-----------------------|-----------------|
| **Repository maintainer** | Creates and structures the GitHub repository, manages branches and merges | Ensures **versioning**, traceability and documentation | Creates repository, manages *pull requests*, merges branches, resolves conflicts |
