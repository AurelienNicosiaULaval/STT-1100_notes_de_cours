...
covid_problematic <- data.frame(
  first_name = sample(c("Jean", "Marie", "Luc", "Chloé", "David"), 50, replace = TRUE),
  last_name = sample(c("Dupont", "Lavoie", "Nguyen", "Morin", "Gagné"), 50, replace = TRUE),
...
covid_problematic <- covid_problematic %>%
  mutate(person = paste(first_name, last_name, ",", age, "years"))
