...
<a class="btn btn-primary" href="../../downloads/donnees/stt1100-module-10-en.zip" download>Download the ready-to-open workspace (.zip)</a>
...
```{r}
#| fig-alt: "Small bar charts of the most frequent words, with one panel for each data producer."
ggplot(
  words_by_producer,
...
```{r}
#| fig-alt: "Horizontal bar chart of mean exploratory lexical scores by data producer."
ggplot(
  precision_by_producer,
...
```{r}
#| fig-alt: "Small orange bar charts of the words with the highest TF-IDF values, with one panel for each producer."
