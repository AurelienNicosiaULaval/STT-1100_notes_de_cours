...
<span class="adventure-brief-value">Early-stage student analyst</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Main contact</span>
<span class="adventure-brief-value">STT-1100 teaching team</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Organization and context</span>
<span class="adventure-brief-value">Introduction to data science course</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Mission</span>
<span class="adventure-brief-value">Prepare a first reproducible report with R, RStudio and Quarto</span>
</div>
<div class="adventure-brief-item">
...
<span class="adventure-brief-value">Short Quarto HTML report</span>
</div>
</div>
</div>
<!-- adventure-brief:end -->
...
![Button to add a code block in RStudio](resources/bouton_chunck.png){fig-alt="RStudio button used to insert an R code block"}
...
Once your report is final, you can generate the report by clicking on the Render button: ![RStudio Render button](resources/bouton_render.png){fig-alt="RStudio Render button used to generate the report"}
...
<ul>
<li>a mini Quarto report that renders to HTML;</li>
<li>two R commands you understand and can explain;</li>
<li>a note about missing values or variables in <code>MeteoQuebec</code>;</li>
<li>one personal rule for keeping an analysis reproducible.</li>
</ul>
</div>
<!-- completed-work:end -->
