...
<div class="resource-page installation-page">
  <section class="resource-hero" aria-labelledby="installation-title">
    <div>
      <p class="eyebrow">Avant la première séance</p>
      <h1 id="installation-title">Préparer votre ordinateur pour STT-1100</h1>
      <p>Suivez cette procédure dans l'ordre pour installer R, RStudio Desktop, Quarto et Git, créer votre compte GitHub, configurer SSH et vérifier un premier rapport reproductible.</p>
      <div class="resource-actions" aria-label="Accès rapides">
        ...
        <a class="home-action" href="packages.html">Voir les packages R</a>
      </div>
    </div>
    <div class="resource-panel" aria-label="Résultat attendu">
      <div><span>01</span><p>Installer les applications</p></div>
      <div><span>02</span><p>Configurer Git et GitHub</p></div>
      <div><span>03</span><p>Installer les packages R</p></div>
      <div><span>04</span><p>Rendre un fichier Quarto</p></div>
    </div>
  </section>
</div>
```
...
## Configurer Git et GitHub {#configurer-git-github}
...
Le résultat doit afficher deux nombres, soit le nombre de lignes et le nombre de colonnes. Les autres packages seront installés au moment où les modules les utilisent; la page [Packages R](packages.html) les répertorie.
