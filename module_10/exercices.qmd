...
<a class="btn btn-primary" href="../downloads/donnees/stt1100-module-10-fr.zip" download>Télécharger le dossier prêt à ouvrir (.zip)</a>
...
```{r}
#| fig-alt: "Petits diagrammes à bandes des mots les plus fréquents, un panneau par producteur de données."
ggplot(
  mots_par_producteur,
...
```{r}
#| fig-alt: "Diagramme à bandes horizontal des scores lexicaux exploratoires moyens selon le producteur de données."
ggplot(
  precision_producteur,
...
```{r}
#| fig-alt: "Petits diagrammes à bandes orange des mots ayant les valeurs TF-IDF les plus élevées, un panneau par producteur."
