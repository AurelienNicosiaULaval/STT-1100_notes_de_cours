...
<span class="adventure-brief-value">Équipe de scientifiques de données</span>
</div>
<div class="adventure-brief-item">
...
<span class="adventure-brief-value">Produire un rapport collaboratif et reproductible sur les retards à JFK</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Données</span>
<span class="adventure-brief-value"><code>nycflights23::flights</code>, <code>airlines</code> et <code>weather</code></span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Livrable</span>
<span class="adventure-brief-value">Rapport collaboratif, rendu HTML, README et traces GitHub</span>
</div>
</div>
</div>
<!-- adventure-brief:end -->
...
<p>À la fin de l'aventure, vérifiez que le travail de l'équipe comprend les éléments suivants. Il ne s'agit pas d'un portfolio séparé.</p>
<ul>
<li>une branche ou une pull request liée à votre rôle;</li>
<li>la table jointe utilisée dans le rapport;</li>
<li>deux visualisations ou éléments reproductibles ajoutés au rapport;</li>
<li>une entrée de journal décrivant une décision, une difficulté ou un conflit GitHub.</li>
</ul>
</div>
<!-- completed-work:end -->
