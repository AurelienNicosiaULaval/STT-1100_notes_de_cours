...
- [Essentiel — Techniques de base en anonymisation de données](../assets/lectures/module_07/techniques-anonymisation-donnees.html){target="_blank"} : page de travail sur les identifiants, quasi-identifiants et risques de réidentification.
- [Essentiel — Pratique responsable en statistique et science des données](../assets/lectures/module_07/aide-memoire-ethique.pdf){target="_blank"} : aide-mémoire pour vérifier les enjeux éthiques d'un projet de données.
