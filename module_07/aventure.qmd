...
<span class="adventure-brief-value">Équipe mandatée en science des données responsable</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Interlocuteur</span>
<span class="adventure-brief-value">Comité d'éthique en science des données</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Organisation et contexte</span>
<span class="adventure-brief-value">Organisation fictive qui soumet un rapport interne problématique</span>
</div>
<div class="adventure-brief-item">
<span class="adventure-brief-label">Mission</span>
<span class="adventure-brief-value">Auditer le rapport, préparer les données et corriger la communication visuelle</span>
</div>
<div class="adventure-brief-item">
...
<span class="adventure-brief-value">Rapport éthique, fichier anonymisé et visualisations corrigées</span>
</div>
</div>
</div>
<!-- adventure-brief:end -->
...
<ul>
<li>une liste structurée des problèmes repérés dans le rapport douteux;</li>
<li>le fichier anonymisé produit;</li>
<li>deux visualisations corrigées;</li>
<li>une note éthique expliquant les limites et les décisions de confidentialité.</li>
</ul>
</div>
<!-- completed-work:end -->
