...
<a class="btn btn-primary" href="../downloads/donnees/stt1100-module-07-fr.zip" download>Télécharger le dossier prêt à ouvrir (.zip)</a>
...
```{r}
#| fig-alt: "Version trompeuse d'un diagramme à bandes horizontal des incidents par type, dont l'axe tronqué amplifie les écarts."
ggplot(
  incidents_type,
...
```{r}
#| fig-alt: "Version défendable du diagramme à bandes horizontal des incidents par type, avec un axe commençant à zéro."
ggplot(
  incidents_type,
  aes(x = reorder(type_incident, total_incidents), y = total_incidents)
) +
...
```{r}
#| fig-alt: "Diagramme à bandes horizontal des incidents de sécurité publique par type, avec les effectifs inscrits sur les barres."
ggplot(
  incidents_type,
  aes(x = reorder(type_incident, total_incidents), y = total_incidents)
) +
...
```{r}
#| fig-alt: "Diagramme à bandes groupées des taux d'incidents enregistrés par année et par type, pour les catégories comptant au moins vingt incidents."
...
```{r}
#| fig-alt: "Diagramme à bandes horizontal des réponses à la question 6 en 2025, après masquage des modalités comptant moins de cinq choix."
